...
export class Tables1704912467010 implements MigrationInterface {
    name = 'Tables1704912467010'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "field" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "boundaries" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "soil_id" uuid, "farm_id" uuid, CONSTRAINT "PK_39379bba786d7a75226b358f81e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cultivation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "crop" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_4cc4355a3e4865a33d580692b71" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."field_cultivation_past_or_present_enum" AS ENUM('past', 'present')`);
        await queryRunner.query(`CREATE TABLE "field_cultivation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "past_or_present" "public"."field_cultivation_past_or_present_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "cultivation_id" uuid, "field_id" uuid, "crop_id" uuid, CONSTRAINT "PK_ed9641bf27693edcdbacadbbffb" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."field_cultivation_past_or_present_enum"`);
