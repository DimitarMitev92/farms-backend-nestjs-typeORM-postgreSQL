...
export class Table1705475072165 implements MigrationInterface {
    name = 'Table1705475072165'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "farm" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "location" text NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_3bf246b27a3b6678dfc0b7a3f64" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "field" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "boundaries" jsonb NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "soil_id" uuid, "farm_id" uuid, CONSTRAINT "PK_39379bba786d7a75226b358f81e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "growing_process" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "crop_id" uuid, "field_id" uuid, CONSTRAINT "PK_d7f9cf5bdb1acd4660281c4319d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "growing_process" ADD CONSTRAINT "FK_672f60cc064ebe75115361081c6" FOREIGN KEY ("crop_id") REFERENCES "crop"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "growing_process" ADD CONSTRAINT "FK_6fe05657a8ea40e0850005e850a" FOREIGN KEY ("field_id") REFERENCES "field"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "field_cultivation" ADD CONSTRAINT "FK_a39af6f7e578bf40abfa5196eaa" FOREIGN KEY ("growing_process_id") REFERENCES "growing_process"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "growing_process" DROP CONSTRAINT "FK_6fe05657a8ea40e0850005e850a"`);
        await queryRunner.query(`ALTER TABLE "growing_process" DROP CONSTRAINT "FK_672f60cc064ebe75115361081c6"`);
        ...
        await queryRunner.query(`DROP TABLE "growing_process"`);
